...
get("/blackjack") do
  ...
  @dealerCardCollection = [@dealers_first_value.to_i,@dealers_second_value.to_i,@dealers_third_value.to_i,@dealers_fourth_value.to_i,@dealers_fifth_value.to_i,@dealers_sixth_value.to_i]

  @playerCardCollection = [@card_one_value.to_i,@card_two_value.to_i,@card_three_value.to_i,@card_four_value.to_i,@card_five_value.to_i,@card_six_value.to_i]
